...
<div className='foot'>
  <ul className='footer-menu' style={{margin:'auto',fontWeight:'bolder', display:'flex',width:'22rem',listStyle:'none',height:'2rem',justifyContent:'space-between'}}> <li>Info</li> <li>Support</li> <li>Marketing</li> <li>Refund</li></ul>
  <ul className='footer-link' style={{display:'flex',fontWeight:'bolder',width:'22rem',listStyle:'none',height:'2rem',justifyContent:'space-between',marginTop:'6px'}}>  <li>Terms of Use</li> <li>Privacy Policy</li> <li>Career</li> <li>About</li></ul>
  </div>
</section>
