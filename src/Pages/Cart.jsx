...
const Cart = () => {
    ...
    <div>
  {
    ...
    (<div className=" h-auto my-12 md:w-[90%] m-auto relative flex flex-col  md:flex-row justify-center ">
      ...
      <h1 className=" py-4 w-[98%] m-auto text-xl ml-2 font-mono font-extrabold">MY BAG</h1>
        ...
        <p className=" py-2 ml-2 font-bold">Total Amount: <span className="font-normal"> ${totalAmount} </span></p>
      </div>

      <div className=" border-2 border-black md:w-[40%] m-auto w-[95%] h-[18.7rem]  mt-2">
  ...
  <hr class="h-px my-2 bg-gray-300 border-0 "></hr>
        <div className="py-2">
          ...
          <p>
            <span className="font-bold">Total Items: <span className="font-normal">{cart.length} </span></span>
          </p>
